...
/*   Updated: 2022/02/19 18:39:34 by ntitan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	error(t_data *data, int32_t *a1)
{
	free_data(data);
	free(a1);
	write(2, "Error\n", 6);
...
static int	check_ligit(t_data *data, int32_t *a1)
{
	int i;
	int j;
...
static int	go_more(t_data *data, int32_t *a1)
{
